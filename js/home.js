...
(function () {
  ...
  function buildMechanism() {
    ...
    if (!el) return;
    el.innerHTML = `<div class="mechanism-empty-state" role="status"><span class="mechanism-empty-icon" aria-hidden="true"><i class="fa-solid fa-layer-group"></i></span><strong>正在开发</strong><p>机制＋专题页面正在建设中，相关工作机制和专题内容将陆续接入。</p></div>`;
  }
